...
from robot_skills.arm import arms, force_sensor, gripper, handover_detector, grasp_detector
...
class Hero(robot.Robot):
    ...
    def __init__(self, wait_services=False):
        ...
        hero_arm.add_part('grasp_detector',grasp_detector.GraspDetector(self.robot_name, self.tf_buffer, "/" + self.robot_name + "/wrist_wrench/raw"))
